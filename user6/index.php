...
<body class="is-loading">
	...
	<div id="wrapper" class="fade-in">
		...
		<nav id="nav">
			<ul class="links">
				<li class="active"><a href="../user6/index.php">Home</a></li>
				<li><a href="../user6/Document.php">Document search</a></li>
				...
				<div class="table-wrapper">
						...
						while ($row = mysqli_fetch_array($result)) {
							?>			
									<tr>
										<td>
											<?php echo "$year /";?><a href="../user6/accessDocument.php?documentId=<?php echo $row['documentId']?>" ><?php echo $row['documentId'];?></a>
