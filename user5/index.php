...
<body class="is-loading">
	...
	<div id="wrapper" class="fade-in">
		...
		<nav id="nav">
			<ul class="links">
				<li class="active"><a href="../user5/index.php">Home</a></li>
				<li><a href="../user5/Document.php">Document search</a></li>
				<li><a href="../user5/private.php?userId=<?php echo $_SESSION['ses_userId']?>">private</a></li>
				...
				<div class="table-wrapper">
						...
						while ($row = mysqli_fetch_array($result)) {
							?>			
									<tr>
										<td>
											<?php echo "$year /";?><a href="../user5/accessDocument.php?documentId=<?php echo $row['documentId']?>" ><?php echo $row['documentId'];?></a>
